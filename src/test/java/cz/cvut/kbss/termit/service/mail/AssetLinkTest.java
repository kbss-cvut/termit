...
class AssetLinkTest {
    ...
    void createLinkWithTermReplacesVariablesInUrlPatternWithTermValues() {
        ...
        assertThat(result, containsString(FrontendPaths.TERM_PATH.replace("{vocabularyName}", IdentifierResolver.extractIdentifierFragment(term.getVocabulary()))
                                                                 .replace("{termName}", IdentifierResolver.extractIdentifierFragment(term.getUri()))
                                                                 .replace("{vocabularyNamespace}", IdentifierResolver.extractIdentifierNamespace(term.getVocabulary()))));
    ...
    void createLinkWithVocabularyReplacesVariablesInUrlPatternWithTermValues() {
        ...
        assertThat(result, startsWith(BASE_URL));
        assertThat(result, containsString(FrontendPaths.VOCABULARY_PATH.replace("{vocabularyName}", IdentifierResolver.extractIdentifierFragment(vocabulary.getUri()))
                                                                       .replace("{vocabularyNamespace}", IdentifierResolver.extractIdentifierNamespace(vocabulary.getUri()))));
